...
// The real hosted backend (agent/main.py on Render) -- login/connect
// always let you override with --api-base, this is just the fallback
// default. Swap for a custom domain once one exists.
const DEFAULT_API_BASE = "https://argox-cflf.onrender.com";
